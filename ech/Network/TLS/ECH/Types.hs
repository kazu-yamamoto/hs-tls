...
module Network.TLS.ECH.Types where
...
data HpkePublicKey = HpkePublicKey ByteString deriving (Eq)

instance Show HpkePublicKey where
    show (HpkePublicKey pub) = C8.unpack $ B16.encode pub
